  ...
  return (
    <Container>
      <View className="flex-row flex-wrap justify-between px-4 mt-8">
        ...
        <Card img={require("../img/logo_SAIA.png")} text="Insumos" onPress={() => router.push("/insumo")}/>
        <Card img={require("../img/logo_SAIA.png")} text="Reportes" />
        <Card img={require("../img/logo_SAIA.png")} text="Perfil Aprendiz" onPress={() => router.push("/perfil")} />
    </View>
    </Container >
  );
};
